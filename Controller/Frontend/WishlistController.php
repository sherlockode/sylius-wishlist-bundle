...
class WishlistController extends FOSRestController
{
    ...
    public function showAction(Request $request)
    {
        ...
        $wishlist = $this->get('sherlockode_wishlist.repository.wishlist')->findOneBy([
    ...
    public function firstAction(Request $request)
    {
        ...
        $wishlist =
            $this->get('sherlockode_wishlist.repository.wishlist')->getFirstForUser($this->getUser());

        // Create a wishlist if none exist
        if (!$wishlist) {
            $wishlist = $this->get('sherlockode_wishlist.factory.wishlist')->createDefault($this->getUser());
        ...
        if ($this->getParameter('sherlockode_sylius_wishlist.multiple')) {
    ...
    public function clearAction(Request $request)
    {
        ...
        $this->addFlash(
            'success',
            $this->get('translator')->trans('sherlockode_wishlist.flash.cleared')
        );
