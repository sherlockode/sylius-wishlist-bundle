...
namespace Sherlockode\Sylius\WishlistBundle\Command;
...
class CreateInitialCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('sherlockode:sylius-wishlist-bundle:create-initial')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $wishlistRepository = $this->getContainer()->get('sherlockode_wishlist.repository.wishlist');

        /** @var WishlistFactoryInterface $wishlistFactory */
        $wishlistFactory = $this->getContainer()->get('sherlockode_wishlist.factory.wishlist');
